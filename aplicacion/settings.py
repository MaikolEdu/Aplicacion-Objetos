...
DATABASES = {
    'default': {
        ...
        'NAME': 'transportes.db',                      # Or path to database file if using sqlite3.
...
MEDIA_URL = 'http://192.168.1.33:8000/media/'
...
SECRET_KEY = 'wj-bt4xyni%s5$e+23t$6!zui3bu_6r_y2_7jfq@m7)0+dmzmu'
